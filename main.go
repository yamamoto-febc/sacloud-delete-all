...
func cliFlags(option *lib.Option) []cli.Flag {
	...
	return []cli.Flag{
		...
		&cli.BoolFlag{
			Name:        "force",
			Usage:       "Flag of force delete mode",
			EnvVars:     []string{"FORCE"},
			Destination: &option.ForceMode,
			Value:       false,
		},
